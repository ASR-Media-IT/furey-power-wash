...
const SimpleText = ({ slice }) => {
  return (
    <div className={slice.primary.background ? "bg-black" : ""}>
      <Container
    ...
    >
      <div className={`flex flex-col ${slice.variation === "centered" ? "items-center text-center" : "items-start"}`}>
        ...
        <div className={slice.primary.background ? "bg-primary-600 h-0.5 max-w-sm w-full mt-3 mb-3" : "bg-primary-600 h-0.5 max-w-sm w-full mt-3 mb-3"}></div>
